    ...
    <section className="py-24 md:py-36">
      <div className="container">
        <ScrollReveal>
          <div className="text-center max-w-[600px] mx-auto mb-14">
            <div className="flex items-center justify-center gap-2.5 mb-4">
              ...
              <span className="text-xs font-semibold tracking-[0.25em] uppercase text-gold">The Problem</span>
            </div>
            ...
            <p className="text-[0.9375rem] leading-[1.8] font-light text-muted-foreground max-w-[480px] mx-auto">
        ...
        <StaggerReveal className="grid md:grid-cols-3 gap-3 mb-10" stagger={0.15}>
          {stats.map((s, i) => (
            <MotionCard key={i}>
              <Card className="text-center p-9 h-full">
                ...
                <p className="text-[0.8125rem] text-warm-500 leading-[1.8]">{s.label}</p>
              </Card>
            </MotionCard>
          ))}
        </StaggerReveal>
        ...
        <ScrollReveal direction="scale">
          <Card className="relative overflow-hidden text-center p-11 hover:translate-y-0">
            ...
            <p className="relative text-[0.9375rem] leading-[1.8] font-light text-muted-foreground max-w-[560px] mx-auto">
