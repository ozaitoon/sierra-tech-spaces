        ...
        <ScrollReveal>
          <div className="text-center max-w-[600px] mx-auto mb-14">
            <div className="flex items-center justify-center gap-2.5 mb-4">
              ...
              <span className="text-xs font-semibold tracking-[0.25em] uppercase text-gold">Services</span>
            </div>
            ...
            <ScrollReveal key={tier.name} delay={i * 0.12} direction={i === 0 ? "left" : i === 2 ? "right" : "up"}>
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 mb-6">
                  <h3 className="font-display font-bold text-[clamp(1.5rem,3vw,2rem)] text-foreground tracking-[-0.04em]">
                    {tier.name}
                  </h3>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {tier.items.map((item) => (
                    <div key={item.title} className="space-y-0.5">
                      ...
                      <div className="text-[0.8125rem] text-warm-500 leading-[1.8]">{item.desc}</div>
